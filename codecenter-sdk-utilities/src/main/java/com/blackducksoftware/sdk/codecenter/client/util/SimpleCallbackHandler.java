...
// TODO doc
public class SimpleCallbackHandler implements CallbackHandler, Closeable {
            ...
            for (Callback callback : callbacks) {
                if (callback instanceof NameCallback) {
                    ...
                    throw new UnsupportedCallbackException(callback,
                            "Only " + NameCallback.class.getName() + " and " + PasswordCallback.class.getName() + " are supported");
                }
            }
        }
    }
