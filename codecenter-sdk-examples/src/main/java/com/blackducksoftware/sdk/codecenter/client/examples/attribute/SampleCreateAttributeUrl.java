...
public class SampleCreateAttributeUrl extends SampleCreateAttributeNotReadOnly<SimpleAttributeDefinition> {

    public static void main(String[] args) {
        new SampleCreateAttributeUrl(args).run();
    }

    @Argument(index = 6, metaVar = "defaultValue", usage = "the default URL")
    protected String defaultValue;

    public SampleCreateAttributeUrl(String[] args) {
        super(args);
    }
    ...
    protected SimpleAttributeDefinition createAttribute_() {
        ...
        attribute.setType(AttributeTypeEnum.URL);
