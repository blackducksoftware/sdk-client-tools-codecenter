...
public class StaticSearchTermOptionHandler extends SearchTermOptionHandler {

    public StaticSearchTermOptionHandler(CmdLineParser parser, OptionDef option, Setter<? super SearchTerm> setter) {
