...
public class SampleDeleteAttributeGroup extends BDCodeCenterSample {

    public static void main(String[] args) {
        new SampleDeleteAttributeGroup(args).run();
    }

    @Argument(index = 3, required = true, metaVar = "name", usage = "the name of the attribute group to delete")
    protected String name;

    public SampleDeleteAttributeGroup(String[] args) {
        super(args);
    }
    ...
    public void run(CodeCenterServerProxy proxy) throws Exception {
        ...
        proxy.getAttributeApi().deleteAttributeGroup(nameToken);

        // Print success information
        System.out.println("Successfully deleted attribute group \"" + name + "\".");
    }
